...
var require_react_fast_compare = __commonJS({
  "../../node_modules/react-fast-compare/index.js"(exports, module) {
    ...
    module.exports = function isEqual2(a2, b3) {
      try {
        return equal(a2, b3);
      } catch (error) {
...
init_esm_shims();
import { useState as o, useEffect as t2 } from "react";
var r = { serverHandoffComplete: false };
function a() {
  let [e2, f5] = o(r.serverHandoffComplete);
  return t2(() => {
    e2 !== true && f5(true);
  }, [e2]), t2(() => {
...
var I = (u = t3.useId) != null ? u : function() {
  let n2 = a(), [e2, o6] = t3.useState(n2 ? r2 : null);
  return t(() => {
    e2 === null && o6(r2());
...
init_esm_shims();
import { useRef as t4 } from "react";
function s(e2) {
  let r5 = t4(e2);
  return t(() => {
    r5.current = e2;
...
init_esm_shims();
import { useRef as o2, useEffect as i, useCallback as f2 } from "react";
var l2 = Symbol();
function T(...n2) {
  let t8 = o2(n2);
  i(() => {
...
init_esm_shims();
import { Fragment as c, cloneElement as T2, createElement as g, forwardRef as F, isValidElement as h } from "react";
...
function p(r5, t8 = {}, e2, n2) {
  ...
  if (s5.className && typeof s5.className == "function" && (s5.className = s5.className(t8)), o6 === c && Object.keys(y(s5)).length > 0) {
    if (!h(i4) || Array.isArray(i4) && i4.length > 1)
...
`)].join(`
`));
    return T2(i4, Object.assign({}, m(i4.props, y(f3(s5, ["ref"]))), u3));
  }
  return g(o6, Object.assign({}, f3(s5, ["ref"]), o6 !== c && u3), i4);
}
function m(...r5) {
  var n2;
  if (r5.length === 0)
...
function H(r5) {
  var t8;
  return Object.assign(F(r5), { displayName: (t8 = r5.displayName) != null ? t8 : r5.name });
}
function y(r5) {
...
init_esm_shims();
import { useRef as m2 } from "react";
...
init_esm_shims();
import r4, { createContext as l3, useContext as d2 } from "react";
var o4 = l3(null);
...
function C2({ value: t8, children: n2 }) {
  return r4.createElement(o4.Provider, { value: t8 }, n2);
}
...
init_esm_shims();
import { useMemo as t7 } from "react";
function n(...e2) {
  return t7(() => t6(...e2), [...e2]);
}
...
init_esm_shims();
import F3, { createContext as D, useCallback as m3, useContext as _, useEffect as x2, useMemo as O2, useReducer as le, useRef as M2, useState as pe } from "react";
...
var Se = H(function(o6, f5) {
  let e2 = `headlessui-popover-button-${I()}`, P = `headlessui-popover-panel-${I()}`, n2 = M2(null), l4 = T(f5, n2), i4 = n(n2), s5 = le(Te, { popoverState: 1, button: null, buttonId: e2, panel: null, panelId: P }), [{ popoverState: v, button: t8, panel: E3 }, u3] = s5;
  x2(() => u3({ type: 3, buttonId: e2 }), [e2, u3]), x2(() => u3({ type: 5, panelId: P }), [P, u3]);
  let S = O2(() => ({ buttonId: e2, panelId: P, close: () => u3({ type: 1 }) }), [e2, P, u3]), c2 = re(), d4 = c2 == null ? void 0 : c2.registerPopover, p4 = m3(() => {
    var r5;
  ...
  x2(() => d4 == null ? void 0 : d4(S), [d4, S]), E2(i4 == null ? void 0 : i4.defaultView, "focus", () => {
  ...
  let y2 = m3((r5) => {
    ...
    T4 == null || T4.focus();
  }, [u3, t8]), b3 = O2(() => ({ close: y2 }), [y2]), g2 = O2(() => ({ open: v === 0, close: y2 }), [v, y2]), C3 = o6, h3 = { ref: l4 };
  return F3.createElement(z.Provider, { value: s5 }, F3.createElement(J.Provider, { value: b3 }, F3.createElement(C2, { value: u2(v, { [0]: p2.Open, [1]: p2.Closed }) }, A({ ourProps: h3, theirProps: C3, slot: g2, defaultTag: Ee, name: "Popover" }))));
});
var be = "button";
var me = H(function(o6, f5) {
  let [e2, P] = N2("Popover.Button"), n2 = M2(null), l4 = re(), i4 = l4 == null ? void 0 : l4.closeOthers, s5 = ye(), v = s5 === null ? false : s5 === e2.panelId, t8 = T(n2, f5, v ? null : (r5) => P({ type: 2, button: r5 })), E3 = T(n2, f5), u3 = n(n2), S = M2(null), c2 = M2(null);
  ...
  }, [P, e2.popoverState, e2.buttonId, e2.button, e2.panel, n2, i4, v]), p4 = m3((r5) => {
    var T4;
  ...
  }, [e2.popoverState, e2.panel, e2.button, v]), y2 = m3((r5) => {
    var T4, R;
...
var Ce = H(function(o6, f5) {
  let [{ popoverState: e2 }, P] = N2("Popover.Overlay"), n2 = T(f5), l4 = `headlessui-popover-overlay-${I()}`, i4 = s3(), s5 = (() => i4 !== null ? i4 === p2.Open : e2 === 0)(), v = m3((S) => {
    if (r3(S.currentTarget))
      return S.preventDefault();
    P({ type: 1 });
  }, [P]), t8 = O2(() => ({ open: e2 === 0 }), [e2]);
...
var Ie = H(function(o6, f5) {
  let _a = o6, { focus: e2 = false } = _a, P = __objRest(_a, ["focus"]), [n2, l4] = N2("Popover.Panel"), { close: i4 } = oe("Popover.Panel"), s5 = M2(null), v = T(s5, f5, (p4) => {
    l4({ type: 4, panel: p4 });
  }), t8 = n(s5), E3 = s3(), u3 = (() => E3 !== null ? E3 === p2.Open : n2.popoverState === 0)(), S = m3((p4) => {
    var y2;
    switch (p4.key) {
      case o3.Escape:
  ...
  let c2 = O2(() => ({ open: n2.popoverState === 0, close: i4 }), [n2, i4]), d4 = { ref: v, id: n2.panelId, onKeyDown: S };
  return F3.createElement(X.Provider, { value: n2.panelId }, A({ ourProps: d4, theirProps: P, slot: c2, defaultTag: Re, features: Oe, visible: u3, name: "Popover.Panel" }));
});
var Le = "div";
var xe = H(function(o6, f5) {
  let e2 = M2(null), P = T(e2, f5), [n2, l4] = pe([]), i4 = m3((d4) => {
    l4((p4) => {
  ...
  }, [l4]), s5 = m3((d4) => (l4((p4) => [...p4, d4]), () => i4(d4)), [l4, i4]), v = m3(() => {
    var y2;
    let d4 = t6(e2);
    if (!d4)
      return false;
  ...
  }, [n2]), E3 = O2(() => ({ registerPopover: s5, unregisterPopover: i4, isFocusWithinPopoverGroup: v, closeOthers: t8 }), [s5, i4, v, t8]), u3 = O2(() => ({}), []), S = o6, c2 = { ref: P };
  return F3.createElement(Q.Provider, { value: E3 }, A({ ourProps: c2, theirProps: S, slot: u3, defaultTag: Le, name: "Popover.Group" }));
});
...
function Portal(_a) {
  ...
  const protectedAreaRef = React13.useRef(null);
  React13.useEffect(() => {
  ...
  return ReactDOM2.createPortal(/* @__PURE__ */ React13.createElement("div", __spreadValues({
    id: "portal",
    className: "fixed inset-0 z-[99]",
    onClick: toggle
  }, props), /* @__PURE__ */ React13.createElement("div", {
